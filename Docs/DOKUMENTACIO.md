...
* **Saját profil és előzmények:** A felhasználók transzparens módon kezelhetik saját foglalásaikat, ahol lehetőség van az időpontok lemondására és újak foglalására.
...
* **Szolgáltatások menedzselése:** Az összes foglalás egy központi táblázatban követhető, ahol az adminisztrátorok manuális beavatkozásra (törlés, módosítás) is jogosultak.
